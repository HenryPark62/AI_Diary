...
const OAUTH_KAKAO_URL = `${API_HOST}/oauth2/authorization/kakao`;
const OAUTH_GOOGLE_URL = `${API_HOST}/oauth2/authorization/google`;
...
const Auth = () => {
  ...
  const handleKakaoLogin = () => {
    window.location.href = OAUTH_KAKAO_URL;
  };
